...
vec3 calcPointLight(pointLight light, vec3 normal, vec3 fragPos, vec3 viewDir, float shadow, vec3 specIntensity)
{
...
void main()
{
	...
	//shadow = 1.0f;
	colOutput = calcPointLight(pLights[u_lightIndex], normal, v_fragPos, viewDir, shadow, specIntensity);
